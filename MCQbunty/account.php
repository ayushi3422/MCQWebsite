...
<div class="row">
<div class="col-lg-6">
<span class="logo">~MCQ_Bunty_WEBSITE~</span></div>
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">@Organized by bunty@</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">bunty</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">bunty</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 ----------</h4>
		<h4 style="font-family:'typo' ">?????@gmail.com</h4>
		<h4 style="font-family:'typo' "> hello good morning/ good night </h4></div></div>
		</p>
      </div>
