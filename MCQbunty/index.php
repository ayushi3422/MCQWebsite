  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:darkblue;font-size:12px;font-weight: bold">_Login Here_</span></h4>
      </div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your Roll no (Ex.100,101)" class="form-control input-md" type="text" value="<?php
...
<a href="#" data-toggle="modal" data-target="#login" style="color:lightyellow">~Admin_Login~</a></div>
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">@Organized by bunty@<br><br></span>
</div>
